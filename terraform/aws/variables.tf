...
variable "application_name" {
  ...
  type        = string
  nullable    = false
  default     = "extension-app-data-io-cs"
...
variable "application_build_base_image_name" {
  description = "Deprecated compatibility alias for the runtime base image. If non-empty, it overrides application_build_runtime_image_name."
  type        = string
  nullable    = false
  default     = ""
}

variable "application_build_sdk_image_name" {
  description = "The SDK image to use for the application build stages"
  type        = string
  nullable    = false
  default     = "mcr.microsoft.com/dotnet/sdk:10.0"
}

variable "application_build_runtime_image_name" {
  description = "The runtime image to use for the final application container stage"
  type        = string
  nullable    = false
